<!-- footer -->
			...
			<footer class="footer">
				<div class="container-fluid">
					<div class="copyright ml-auto">
						Copyright © 2021<a href="#"> Singgang</a>
					</div>				
				</div>
			</footer>
		</div>
	...
	<!-- App -->
	<script src="<?= base_url() ?>assets/app/dashboard-super.js"></script>
	<script src="<?= base_url() ?>assets/app/kategori.js"></script>
	<script src="<?= base_url() ?>assets/app/pegawai.js"></script>
	<script src="<?= base_url() ?>assets/app/progress.js"></script>
